...
async function main() {
  ...
  //     background: '1. Kesenjangan sarana dan akses perahu antar kampung wisata pesisir mencapai 55%.\n2. Perlindungan zona inti hutan mangrove membutuhkan regulasi zonasi daerah yang mengikat.\n3. Standardisasi pembinaan kelompok sadar wisata (Pokdarwis) lokal masih belum dilembagakan.',
  //     policyRecommendations: '1. JANGKA PENDEK (0-6 Bulan): Penerbitan Surat Edaran Bupati tentang Standarisasi Tarif dan Pembinaan Pokdarwis Pesisir Mimika.\n2. JANGKA MENENGAH (6-18 Bulan): Penyusunan Rancangan Perbup tentang Masterplan Pariwisata Daerah.\n3. JANGKA PANJANG: Alokasi anggaran afirmasi pemberdayaan ekonomi kampung pesisir.',
  //     conclusion: 'Sinergi antar OPD dan kepastian regulasi zonasi akan menjamin kelestarian mangrove sekaligus meningkatkan ekonomi masyarakat adat pesisir.',
  ...
  //     background: '1. Hasil uji laboratorium menunjukkan biskuit sagu fortified ikan laut memiliki kandungan protein dan zink 40% lebih tinggi dibanding makanan pabrikan.\n2. Tingkat penerimaan (akseptabilitas rasa) oleh balita dan ibu di kampung mencapai 92%.\n3. Penggunaan bahan baku lokal menghemat biaya logistik distribusi PMT daerah hingga 35%.',
  //     policyRecommendations: '1. Penerbitan Perbup tentang Standarisasi Menu PMT Berbasis Pangan Lokal Papua di Kabupaten Mimika.\n2. Alokasi wajib minimal 20% dana Bantuan Operasional Kesehatan (BOK) Puskesmas untuk belanja komoditas pangan lokal kelompok tani dan nelayan setempat.\n3. Integrasi pemantauan digital pertumbuhan balita melalui aplikasi SIM-RIDA Dinkes Mimika.',
  //     conclusion: 'Intervensi terarah berbasis komoditas lokal Mimika menjadi strategi paling berkelanjutan dalam percepatan eliminasi stunting balita.',
  //     targetPolicyType: 'DRAFT_PERBUP',
  //     impactLevel: 'STRATEGIS_DAERAH',
